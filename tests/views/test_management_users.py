...
@pytest.mark.django_db
def test_user_edit_view_unauthorized_access(client: Client, user1, user2):
    """
    Test that the view is unavailable if user does not have proper rights to the stock user's user
    """
    client.force_login(user1)
...
@pytest.mark.django_db
def test_user_delete_unauthorized_access(client: Client, user1, user2):
    """
    Test that the view is unavailable if user does not have proper rights to the stock user's user
    """
    client.force_login(user1)
...
@pytest.mark.django_db
def test_user_delete_authenticated_access(client: Client, user1, user2):
    """
    Test that the view is unavailable if user does not have proper rights to the stock user's user
    """
    client.force_login(user2)
